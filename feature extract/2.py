...
data_arg.add_argument(
    "--batch_size", type=int, default=1, help="# of images in each batch of data"
)
data_arg.add_argument(
    "--num_workers",
    type=int,
...
misc_arg.add_argument(
    "--data_dir", type=str, default="E:\数据集\cd\OfficeHomeDataset_10072016\Clipart", help="Directory in which data is stored"
)
misc_arg.add_argument(
    "--test_dir", type=str, default="E:\数据集\cd\OfficeHomeDataset_10072016\Product", help="Directory in which data is stored"
)
misc_arg.add_argument(
    "--ckpt_dir",
    type=str,
