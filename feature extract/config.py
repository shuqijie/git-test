...
misc_arg.add_argument(
    "--data_dir", type=str, default="/home/xu/zy/sqj/bao/data/OfficeHome/Clipart", help="Directory in which data is stored"
)
misc_arg.add_argument(
    "--test_dir", type=str, default="/home/xu/zy/sqj/bao/data/OfficeHome/Product", help="Directory in which data is stored"
)
misc_arg.add_argument(
    "--ckpt_dir",
    type=str,
